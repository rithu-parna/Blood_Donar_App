            ...
            <Container maxWidth="xl">
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    >
                        ...
                        <Typography variant="h5" fontWeight={900} sx={{ letterSpacing: -1.5, color: textColor }}>
                        ...
                        {menuItems.map((item) => (
                            ...
                            >
                                <Typography
                                    sx={{
                                        fontWeight: 800,
                                        color: activePage === item.id ? '#E11D48' : textColor === 'white' ? 'rgba(255,255,255,0.7)' : 'rgba(15, 23, 42, 0.7)',
                                        transition: 'all 0.3s',
                                        fontSize: '0.8rem',
                                        letterSpacing: 1.5,
                                        '&:hover': { color: activePage === item.id ? '#E11D48' : textColor }
                                    }}
                                >
                                    {item.label}
                                </Typography>
