                ...
                <motion.div variants={itemVariants}>
                    <Grid container spacing={2.5} sx={{ mb: 3 }}>
                        ...
                        <Grid item xs={12} md={4}>
                            <Paper sx={{ p: 3.5, borderRadius: 4, boxShadow: '0 10px 40px rgba(0,0,0,0.04)', border: '1px solid #e2e8f0', height: '100%' }}>
                                ...
                                <Box sx={{ mt: 4, p: 2, borderRadius: 3, bgcolor: '#f8fafc', border: '1px dashed #e2e8f0' }}>
                                    <Typography sx={{ fontSize: 11, color: '#94a3b8', fontWeight: 700, mb: 1.5, textTransform: 'uppercase' }}>System Health</Typography>
                                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <Typography sx={{ fontSize: 12, fontWeight: 600 }}>API Status</Typography>
                                        <Chip label="Operational" size="small" sx={{ height: 20, fontSize: 10, bgcolor: '#dcfce7', color: '#16a34a', fontWeight: 700 }} />
                                    </Box>
                                </Box>
                            </Paper>
                        </Grid>
